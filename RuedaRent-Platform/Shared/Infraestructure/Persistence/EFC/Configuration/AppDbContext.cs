...
using ACME.LearningCenter_Platform.Shared.Infraestructure.Persistence.EFC.Configuration.Extensions;
...
namespace ACME.LearningCenter_Platform.Shared.Interfaces.ASP.Configuration;
