using ACME.LearningCenter_Platform.IAM.Infrastructure.Pipeline.Components;

namespace ACME.LearningCenter_Platform.IAM.Infrastructure.Pipeline.Extensions;
